...
public class MazeMethods{
	...
	int pathX[], pathY[], wallX[], wallY[];
	final int BORDER_XL = 5, BORDER_XR = 195, BORDER_YU = 5, BORDER_YD = 195, VICTORY_X = 190, VICTORY_Y = 190;
	
	private void GenBorders(Graphics g){
		//fills border
	...
	private void GenPath(Graphics g){
		//creates path
	...
	private void GenWalls(Graphics g){
